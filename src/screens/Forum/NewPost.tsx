      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-muted-foreground">
            Share experiences, ask questions, and connect with fellow
            adventurers
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6 space-y-4">
            ...
            >
              ...
              <span className="text-foreground font-medium">Upload images</span>
            </button>
            <button
              type="button"
              className="w-full flex items-center px-4 py-3 border border-border rounded-lg hover:bg-secondary transition-colors text-left group"
            >
              ...
              <span className="text-foreground font-medium">Add link</span>
            </button>
          </div>
